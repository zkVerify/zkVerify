...
async function run(nodeName, networkInfo, _args) {
    ...
    beneficiaries_map.set(beneficiary_sr.address, '1000000000000000000');
    beneficiaries_map.set(beneficiary_polkadot_js.address, '1000000000000000000');
    beneficiaries_map.set(beneficiary_ed.address, '1000000000000000000');
    beneficiaries_map.set(beneficiary_ecdsa.address, '1000000000000000000');

    // Begin claim with beneficiary
    const message = "I'm claiming my funds !";
    let events = await sudoInitClaim(alice, beneficiaries_map, '10000000000000000000', message);
