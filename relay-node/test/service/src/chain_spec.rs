...
fn polkadot_testnet_genesis(
    ...
    // Prepare node features with V2 receipts and elastic scaling enabled.
    let mut node_features = NodeFeatures::new();
    node_features
        .resize(node_features::FeatureIndex::FirstUnassigned as usize + 1, false);
    node_features
        .set(node_features::FeatureIndex::CandidateReceiptV2 as u8 as usize, true);
    node_features
