...
// --output
// /home/rdoria/zkVerify/runtime/src/weights/pallet_token_gateway.rs
// --template
...
impl<T: frame_system::Config> pallet_token_gateway::WeightInfo for ZKVWeight<T> {
    ...
    fn create_erc6160_asset(x: u32, ) -> Weight {
        ...
        Weight::from_parts(16_612_390, 3550)
            // Standard Error: 1_128
            .saturating_add(Weight::from_parts(1_191_320, 0).saturating_mul(x.into()))
    ...
    fn teleport() -> Weight {
        ...
        Weight::from_parts(48_701_000, 3979)
    ...
    fn set_token_gateway_addresses(x: u32, ) -> Weight {
        ...
        Weight::from_parts(2_463_630, 0)
            // Standard Error: 52
            .saturating_add(Weight::from_parts(93, 0).saturating_mul(x.into()))
    ...
    fn update_erc6160_asset() -> Weight {
        ...
        Weight::from_parts(15_759_000, 3729)
            .saturating_add(T::DbWeight::get().reads(3_u64))
    ...
    fn update_asset_precision(x: u32, ) -> Weight {
        ...
        Weight::from_parts(901_905, 0)
            // Standard Error: 806
            .saturating_add(Weight::from_parts(1_165_529, 0).saturating_mul(x.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(x.into())))
    }
}