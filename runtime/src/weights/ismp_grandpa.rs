...
//! HOSTNAME: `9f1b7da5dfb2`, CPU: `AMD Ryzen 7 7700 8-Core Processor`
...
impl<T: frame_system::Config> ismp_grandpa::WeightInfo for ZKVWeight<T> {
    ...
    fn add_state_machines(n: u32, ) -> Weight {
        ...
        Weight::from_parts(2_676_293, 0)
            // Standard Error: 1_887
            .saturating_add(Weight::from_parts(1_352_985, 0).saturating_mul(n.into()))
    ...
    fn remove_state_machines(n: u32, ) -> Weight {
        ...
        Weight::from_parts(336_403, 0)
            // Standard Error: 24_367
            .saturating_add(Weight::from_parts(1_455_249, 0).saturating_mul(n.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
    }
}
