...
//! HOSTNAME: `72ba245e40e1`, CPU: `AMD Ryzen 7 7700 8-Core Processor`
...
impl<T: frame_system::Config> pallet_sudo::WeightInfo for ZKVWeight<T> {
    ...
    fn set_key() -> Weight {
        ...
        Weight::from_parts(9_327_000, 1517)
    ...
    fn sudo() -> Weight {
        ...
        Weight::from_parts(9_989_000, 1517)
            .saturating_add(T::DbWeight::get().reads(1_u64))
    }
    /// Storage: `Sudo::Key` (r:1 w:0)
    /// Proof: `Sudo::Key` (`max_values`: Some(1), `max_size`: Some(32), added: 527, mode: `MaxEncodedLen`)
    fn sudo_as() -> Weight {
        ...
        //  Estimated: `1517`
        // Minimum execution time: 9_608_000 picoseconds.
        Weight::from_parts(9_889_000, 1517)
            .saturating_add(T::DbWeight::get().reads(1_u64))
    }
    /// Storage: `Sudo::Key` (r:1 w:1)
    /// Proof: `Sudo::Key` (`max_values`: Some(1), `max_size`: Some(32), added: 527, mode: `MaxEncodedLen`)
    fn remove_key() -> Weight {
        ...
        Weight::from_parts(8_637_000, 1517)
            .saturating_add(T::DbWeight::get().reads(1_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
