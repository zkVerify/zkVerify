...
impl<T: frame_system::Config> crate::parachains::inclusion::WeightInfo for ZKVWeight<T> {
    ...
    fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
        ...
        Weight::from_parts(58_990_921, 26162419598387144)
            // Standard Error: 208_443
            .saturating_add(Weight::from_parts(124_064_962, 0).saturating_mul(u.into()))
            // Standard Error: 208_443
            .saturating_add(Weight::from_parts(142_570_722, 0).saturating_mul(h.into()))
            // Standard Error: 345_416
            .saturating_add(Weight::from_parts(45_215_877, 0).saturating_mul(c.into()))
