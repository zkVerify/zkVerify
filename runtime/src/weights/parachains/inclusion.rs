...
//! Autogenerated weights for `parachains :: inclusion`
//!
//! THIS FILE WAS AUTO-GENERATED USING THE SUBSTRATE BENCHMARK CLI VERSION 46.2.0
//! DATE: 2025-06-05, STEPS: `50`, REPEAT: `20`, LOW RANGE: `[]`, HIGH RANGE: `[]`
//! WORST CASE MAP SIZE: `1000000`
//! HOSTNAME: `ee9149501f4a`, CPU: `AMD Ryzen 7 7700 8-Core Processor`
...
/// Weights for `parachains :: inclusion` using the zkVerify node and recommended hardware.
pub struct ZKVWeight<T>(PhantomData<T>);

impl<T: frame_system::Config> parachains :: inclusion::WeightInfo for ZKVWeight<T> {
    ...
    fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
        ...
        //  Measured:  `1395 + c * (15992 ±0) + h * (92 ±0) + u * (32954 ±0)`
        //  Estimated: `26162419588214208 + c * (16000 ±271) + h * (7630 ±349) + u * (20829 ±147)`
        // Minimum execution time: 343_750_000 picoseconds.
        // Using recorded proof size instead of calculated, as the latter is broken for this benchmark.
        Weight::from_parts(45_684_593, 1395)
            // Standard Error: 242_204
            .saturating_add(Weight::from_parts(128_457_389, 0).saturating_mul(u.into()))
            // Standard Error: 242_204
            .saturating_add(Weight::from_parts(147_834_542, 0).saturating_mul(h.into()))
            // Standard Error: 401_362
            .saturating_add(Weight::from_parts(49_762_268, 0).saturating_mul(c.into()))
            ...
            .saturating_add(Weight::from_parts(0, 20829).saturating_mul(u.into()))
    }
}
