...
impl<T: frame_system::Config> crate::parachains::configuration::WeightInfo for ZKVWeight<T> {
    ...
    fn set_config_with_block_number() -> Weight {
        ...
        Weight::from_parts(10_249_000, 1670)
    ...
    fn set_config_with_u32() -> Weight {
        ...
        Weight::from_parts(10_259_000, 1670)
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    /// Storage: `Configuration::PendingConfigs` (r:1 w:1)
    ...
    fn set_config_with_option_u32() -> Weight {
        ...
        Weight::from_parts(10_039_000, 1670)
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    ...
    fn set_config_with_balance() -> Weight {
        ...
        //  Estimated: `1670`
        // Minimum execution time: 9_788_000 picoseconds.
        Weight::from_parts(10_109_000, 1670)
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    /// Storage: `Configuration::PendingConfigs` (r:1 w:1)
    ...
    fn set_config_with_executor_params() -> Weight {
        ...
        Weight::from_parts(11_682_000, 1670)
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    /// Storage: `Configuration::PendingConfigs` (r:1 w:1)
    ...
    fn set_config_with_perbill() -> Weight {
        ...
        Weight::from_parts(10_209_000, 1670)
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    /// Storage: `Configuration::PendingConfigs` (r:1 w:1)
    ...
    fn set_node_feature() -> Weight {
        ...
        Weight::from_parts(12_163_000, 1670)
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    /// Storage: `Configuration::PendingConfigs` (r:1 w:1)
    ...
    fn set_config_with_scheduler_params() -> Weight {
        ...
        Weight::from_parts(10_200_000, 1670)
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
}
