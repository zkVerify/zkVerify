...
//! HOSTNAME: `4ffbcddb7be0`, CPU: `AMD Ryzen 7 7700 8-Core Processor`
...
// --output
// /data/benchmark/runtime/src/weights/pallet_hyperbridge_aggregations.rs
// --template
...
impl<T: frame_system::Config> pallet_hyperbridge_aggregations::WeightInfo for ZKVWeight<T> {
    ...
    fn dispatch_aggregation() -> Weight {
        ...
        Weight::from_parts(60_453_000, 3593)
