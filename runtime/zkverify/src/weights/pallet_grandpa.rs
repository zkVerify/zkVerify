...
/// Weights for `pallet_grandpa` using the ZKVerify node and recommended hardware.
/// Weight for note_stalled has been auto-generated by the integrated benchmark.
/// Weight for report_equivocation is manually computed as the sum of:
/// - pallet_session::check_membership_proof
/// - pallet_grandpa::check_equivocation_report
/// - pallet_offences::report_offence_grandpa
pub struct ZKVWeight<T>(PhantomData<T>);

impl<T: frame_system::Config> pallet_grandpa::WeightInfo for ZKVWeight<T> {
    fn report_equivocation(validator_count: u32, max_nominators_per_validator: u32) -> Weight {
        ...
        Weight::from_parts(25u64 * WEIGHT_REF_TIME_PER_MICROS, 0)
            ...
            .saturating_add(Weight::from_parts(
                89u64 * WEIGHT_REF_TIME_PER_NANOS * max_nominators_per_validator as u64,
                0,
            ))
            // report offence
            .saturating_add(Weight::from_parts(115u64 * WEIGHT_REF_TIME_PER_MICROS, 0))
            .saturating_add(Weight::from_parts(
    ...
    fn note_stalled() -> Weight {
        Weight::from_parts(2_224_000, 0).saturating_add(DbWeight::get().writes(1))
    }
}
