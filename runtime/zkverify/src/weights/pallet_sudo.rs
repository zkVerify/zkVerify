...
//! HOSTNAME: `e07a7aff4a58`, CPU: `AMD Ryzen 7 7700 8-Core Processor`
...
// --output
// /data/benchmark/runtime/zkverify/src/weights/pallet_sudo.rs
// --template
...
impl<T: frame_system::Config> pallet_sudo::WeightInfo for ZKVWeight<T> {
    ...
    fn set_key() -> Weight {
        ...
        Weight::from_parts(10_499_000, 1517)
    ...
    fn sudo() -> Weight {
        ...
        Weight::from_parts(11_121_000, 1517)
            .saturating_add(T::DbWeight::get().reads(1_u64))
    }
    /// Storage: `Sudo::Key` (r:1 w:0)
    /// Proof: `Sudo::Key` (`max_values`: Some(1), `max_size`: Some(32), added: 527, mode: `MaxEncodedLen`)
    ...
    fn remove_key() -> Weight {
        ...
        Weight::from_parts(9_788_000, 1517)
            .saturating_add(T::DbWeight::get().reads(1_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    /// Storage: `Sudo::Key` (r:1 w:0)
    ...
    fn check_only_sudo_account() -> Weight {
        ...
        Weight::from_parts(7_103_000, 1517)
            .saturating_add(T::DbWeight::get().reads(1_u64))
    }
}
