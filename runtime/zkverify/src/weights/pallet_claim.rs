...
//! HOSTNAME: `c8591a7dc703`, CPU: `AMD Ryzen 7 7700 8-Core Processor`
...
impl<T: frame_system::Config> pallet_claim::WeightInfo for ZKVWeight<T> {
    ...
    /// Storage: `Claim::Beneficiaries` (r:10000 w:10000)
    ...
    fn begin_airdrop(n: u32, ) -> Weight {
        ...
        Weight::from_parts(10_129_000, 3593)
            // Standard Error: 3_825
            .saturating_add(Weight::from_parts(5_512_093, 0).saturating_mul(n.into()))
    ...
    fn claim() -> Weight {
        ...
        //  Measured:  `1959`
        //  Estimated: `3593`
        // Minimum execution time: 76_953_000 picoseconds.
        Weight::from_parts(77_966_000, 3593)
            .saturating_add(T::DbWeight::get().reads(6_u64))
            .saturating_add(T::DbWeight::get().writes(4_u64))
    }
    /// Storage: `Claim::AirdropActive` (r:1 w:0)
    ...
    fn claim_for() -> Weight {
        ...
        Weight::from_parts(81_051_000, 6196)
    ...
    fn add_beneficiaries(n: u32, ) -> Weight {
        ...
        Weight::from_parts(20_388_000, 3593)
            // Standard Error: 3_153
            .saturating_add(Weight::from_parts(5_469_116, 0).saturating_mul(n.into()))
    ...
    fn end_airdrop(n: u32, ) -> Weight {
        ...
        Weight::from_parts(58_729_000, 6196)
            // Standard Error: 2_004
            .saturating_add(Weight::from_parts(1_396_999, 0).saturating_mul(n.into()))
            .saturating_add(T::DbWeight::get().reads(6_u64))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
            .saturating_add(T::DbWeight::get().writes(5_u64))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
