...
impl WeightInfo for () {
    ...
    /// Proof: `SettlementUltrahonkPallet::Vks` (`max_values`: None, `max_size`: Some(1672), added: 4147, mode: `MaxEncodedLen`)
    fn get_vk() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `1809`
        //  Estimated: `5137`
    ...
    /// Proof: `SettlementUltrahonkPallet::Tickets` (`max_values`: None, `max_size`: Some(97), added: 2572, mode: `MaxEncodedLen`)
